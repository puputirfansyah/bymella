...
document.addEventListener('DOMContentLoaded', () => {
    ...
    productMedias.forEach(media => {
        const images = Array.from(media.querySelectorAll('img.product-img'));
        ...
        images.forEach((img, index) => {
            ...
            // Pastikan clone memiliki class yang tepat untuk zoom
            imgClone.className = 'product-img';
        ...
        // Tambahkan tombol navigasi dan hint HANYA JIKA ada lebih dari 1 gambar
        if (images.length > 1) {
            // Teks Hint Geser
